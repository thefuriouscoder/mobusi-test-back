...
/**
 * Base class that represents a row from the 'public.venue' table.
 *
 *
 *
...
abstract class Venue implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\VenueTableMap';
    ...
    /**
     * Initializes internal state of Base\Venue object.
     */
     ...
     *
     * @return $this|Venue The current object, for fluid interface
     */
     ...
     * @return $this|\Venue The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = VenueTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Venue'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('public.venue_id_seq')");
        ...
        $sql = sprintf(
            'INSERT INTO public.venue (%s) VALUES (%s)',
